...
class _$ChapterImpl implements _Chapter {
  _$ChapterImpl({required this.label, required this.id});
...
// 章节 Id
  ...
  @override
  String toString() {
    return 'Chapter(label: $label, id: $id)';
  }
...
abstract class _Chapter implements Chapter {
  factory _Chapter({required final String label, required final String id}) =
      _$ChapterImpl;
