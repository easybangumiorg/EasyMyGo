...
class ExtensionUtils {
  ...
  static Future<String> getFolder(ExtensionLoaderType loaderType, String package) async {
    ...
    return join(applicationDir.path, extensionRootPath, loaderType.name, package);
  }

  static Future<String> getInnerFolder() async {
    return await getFolder(ExtensionLoaderType.inner, InnerSourceFactory.innerExtensionPackage);
  }
